                  ...
                  children: [
                    ...
                    Focus(
                      onFocusChange: (value) async {
                        if (!value) {
                          final result = await context.read<UserService>().checkifUserExists(usernameController.text.trim());
                          if (result == 'OK!') {
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          if (usernameController.text.isEmpty || nameController.text.isEmpty) {
                            showSnackBar(context, 'Input username and name');
                          } else {
                            User user = User(
                          ...
                          if (result != 'OK!') {
                            ...
                            showSnackBar(context, 'New user succesfully created!');
