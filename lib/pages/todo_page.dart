      ...
      child: Slidable(
        ...
        child: CheckboxListTile(
          ...
          onChanged: (value) async {
            String result =  await context.read<TodoService>().toggleTodo(todo);
            if (result != 'OK!') {
              showSnackBar(context, result);
            }
          },
          ...
          title: Text(
            ...
            style: TextStyle(
              color: Colors.white,
              decoration: !todo.done ? TextDecoration.none : TextDecoration.lineThrough,
            ),
          ),
        ),
      ),
